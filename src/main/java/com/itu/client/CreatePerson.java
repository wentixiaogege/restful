...
public class CreatePerson {
	public static final String FILE_PATH = "/home/jiliang/Documents/";

	// This function fills in a Person message based on user input.
	static Person create(BufferedReader stdin, PrintStream stdout)
			throws IOException {
	...
	public static void main(String[] args) throws Exception {
		...
		FileOutputStream output = new FileOutputStream(
				FILE_PATH + p.getName() + ".per");
		p.writeTo(output);
		output.close();
		System.out.println("person info correctly written");
	}
}
